...
site_name = 'tcw'  # user input site name
start = '2017-01-1 19:00:00'
stop = '2018-01-18 15:00:00'
...
adcp = adcp.ix[start:stop]
isco = isco.ix[start:stop]
turb = turb.ix[start:stop]
...
ax2.set_title('ISCO-Turb Correlation')
